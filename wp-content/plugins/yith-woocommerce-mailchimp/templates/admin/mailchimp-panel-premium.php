...
<div class="landing">
    ...
    <div class="section section-even clear" style="background: url(<?php echo YITH_WCMC_URL ?>assets/images/09-bg.png) no-repeat #fff; background-position: 85% 100%">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_WCMC_URL ?>assets/images/09.png" alt="Store integration" />
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_WCMC_URL ?>assets/images/09-icon.png" alt="Store integration" />
