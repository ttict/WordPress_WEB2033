    ...
    <div class="col">
      ...
      <div class="items itembox">
        ...
        <div class="inside" style="display: none;">
          ...
          <ul>
            <li>Share - use 20 services for sharing the page: Facebook, Twitter, Linkedin, Google, XING, Pinterest, VK, Odnoklassniki, Myspace, Weibo, Buffer, StumbleUpon, Reddit, Tumblr, Blogger, LiveJournal, Pocket, Telegram, Skype, Email  </li>
      ...
      <div class="items itembox">
        ...
        <div class="inside" style="display: none;">          
          <p>Create a custom submenu that can be opened either by click or by hovering. Use different types of submenus to display:</p>
          <ul>
            <li>Under</li>
            <li>Side</li>
            <li>Сircular</li>
      ...
      <div class="items itembox">
        ...
        <div class="inside" style="display: none;">
          <p>You can customize your own icon for the menu item. Upload your own icons and make your menu even more informative.</p>
